...
public class Chat {
    ...
    public Chat(String firstname, String lastname, String personal_contact, String nextofkin_phone,
                double latitude,double longitude,
                String date, String message, String receiver_type, String senderEmail, String timestamp) {
